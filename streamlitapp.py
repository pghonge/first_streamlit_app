...
fruit_added = streamlit.text_input('What fruit would you like information about?','jackfruit')
...
mycur.execute("insert into PC_RIVERY_DB.PUBLIC.fruit_load_list values ('from streamlittest')");
